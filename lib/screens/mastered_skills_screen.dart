      ...
      body:
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              title: Text(masteredSkill['area_name']),
              subtitle: Text(masteredSkill['item_name']),
              trailing: Checkbox(
                    ...
                    if (value == false) {
                      final ok = await showDialog(
                          ...
                          builder: (_) => AlertDialog(
                            ...
                            content: const Text('Are you sure you want to mark this skill as not mastered and continue to walk on it?'),
                            actions: [
                      ...
                      if (!context.mounted  || ok != true) return;
                        final masteredSkillsNotifier = ref.read(masteredSkillsProvider.notifier);
                        await masteredSkillsNotifier.toggleMasteredSkill(masteredSkill['id'] as int, false);
